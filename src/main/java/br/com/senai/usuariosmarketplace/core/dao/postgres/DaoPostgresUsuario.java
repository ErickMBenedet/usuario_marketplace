...
public class DaoPostgresUsuario implements DaoUsuario {
	...
	public final String INSERT = "INSERT INTO usuarios (login, nome, senha) VALUES (?, ?, ?)";
	public final String UPDATE = "UPDATE usuarios SET nome = ?, senha = ? WHERE login = ?";
	...
	private Usuario extrairDo(ResultSet rs) {
		try {
			...
			throw new RuntimeException("Deu um erro ao extrair o usuário. Motivo: " + e.getMessage());
		}finally {
