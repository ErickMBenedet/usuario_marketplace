...
public class UsuarioService {
	...
	public Usuario criarPor(String nomeCompleto, String senha) {
		...
		this.dao.inserirUsuario(novoUsuario);
	...
	public Usuario atualizarPor(String login, String nomeCompleto, String senhaAntiga, String senhaNova) {
		...
		Preconditions.checkArgument(!senhaAntiga.equals(senhaNova), "A senha não pode ser igual a senha anterior");
		...
		this.dao.alterarUsuario(usuarioAlterado);
		usuarioAlterado = dao.buscarPor(login);
		return usuarioAlterado;
	}
	
	public Usuario buscarPor(String login) {
		Preconditions.checkArgument(!Strings.isNullOrEmpty(login), "O login é obrigatório, seu burro");
